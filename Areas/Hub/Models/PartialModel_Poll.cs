...
{
	public class PartialModel_Poll: PartialModel
	{
		public PartialModel_Poll(string currentPage, LetsGame_Poll poll, LetsGame_UserPollVote userVote, bool isCreator) :base (currentPage) {
			Poll = poll;
			UserVote = userVote;
			IsCreator = isCreator;
		}
